...
// const techLogos = [
//   // Top Left Group
//   { id: 1, name: "js", position: { top: "5%", left: "10%" } },
//   { id: 2, name: "ts", position: { top: "10%", left: "15%" } },
//   { id: 3, name: "nextjs", position: { top: "15%", left: "20%" } },
//   { id: 4, name: "firebase", position: { top: "20%", left: "25%" } },

//   // Top Right Group
//   { id: 5, name: "mysql", position: { top: "5%", left: "70%" } },
//   { id: 6, name: "react", position: { top: "10%", left: "75%" } },
//   { id: 7, name: "C++", position: { top: "15%", left: "80%" } },
//   { id: 8, name: "Python", position: { top: "20%", left: "85%" } },

//   // Middle Group (Row 1)
//   { id: 9, name: "Electron", position: { top: "40%", left: "30%" } },
//   { id: 10, name: "GO", position: { top: "40%", left: "50%" } },
//   { id: 11, name: "SASS", position: { top: "40%", left: "70%" } },
//   { id: 12, name: "SQLite", position: { top: "45%", left: "50%" } },

//   // Middle Group (Row 2)
//   { id: 13, name: "MongoDB", position: { top: "50%", left: "30%" } },
//   { id: 14, name: "Tailwind", position: { top: "50%", left: "70%" } },
//   { id: 15, name: "MUI", position: { top: "55%", left: "50%" } },
//   { id: 16, name: "GraphQL", position: { top: "60%", left: "60%" } },

//   // Bottom Group
//   { id: 17, name: ".NET", position: { top: "75%", left: "15%" } },
//   { id: 18, name: "Azure", position: { top: "75%", left: "35%" } },
//   { id: 19, name: "Lua", position: { top: "75%", left: "65%" } },
//   { id: 20, name: "YAML", position: { top: "75%", left: "85%" } },
// ];