...
const ProjectPage: React.FC<ProjectPageProps> = ({
  ...
  return (
    <div
      className="project-page px-6 py-10 text-white mt-28"
      style={{
    ...
    >
      ...
      {/* Detailed Technology Overview with Animated Badges */}
    ...
    {(buttons || []).map((button, index) => (
      ...
      >
        <img
          ...
          className="w-6 h-6"
        />
        <span className="text-sm font-semibold mt-1">{button.label}</span>
      </motion.a>
    ))}
  </div>
</motion.div>
